...
print(area(5, 12))
''' Функция area получает на вход два числа(5, 12) и возвращает площадь заданного треугольника = 30 '''
print(perimeter(8, 4, 7))
''' Функция perimeter получает на вход три числа(8, 4, 7) и возвращает периметр заданного треугольника = 19 '''
